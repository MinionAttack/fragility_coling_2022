...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Ancient_Greek/Perseus/grc_perseus-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Ancient_Greek/PROIEL/grc_proiel-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Bulgarian-BTB/bg_btb-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Catalan-AnCora/ca_ancora-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Chinese-GSD/zh_gsd-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Czech/CAC/cs_cac-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Czech/CLTT/cs_cltt-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Czech/FicTree/cs_fictree-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Czech/PDT/cs_pdt-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Dutch/Alpino/nl_alpino-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Dutch/LassySmall/nl_lassysmall-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/English-EWT/en_ewt-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Finnish-TDT/fi_tdt-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/French-GSD/fr_gsd-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/German-GSD/de_gsd-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Hebrew-HTB/he_htb-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Italian-ISDT/it_isdt-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Norwegian/Bokmaal/no_bokmaal-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Norwegian/Nynorsk/no_nynorsk-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Romanian-RRT/ro_rrt-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Russian/GSD/ru_gsd-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Russian/SynTagRus/ru_syntagrus-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Spanish/AnCora/es_ancora-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Spanish/GSD/es_gsd-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Tamil-TTB/ta_ttb-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Uyghur-UDT/ug_udt-ud-test_udpipe.conll
done
...
for index in {1..3}; do
  CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=4 python -W ignore::UserWarning -u parsing.py \
    ...
    --test data/Pruebas/UD/Wolof-WTB/wo_wtb-ud-test_udpipe.conll
done
