...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Ancient_Greek/Perseus/Iteracion_"$index"/grc_perseus-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Ancient_Greek/PROIEL/Iteracion_"$index"/grc_proiel-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Bulgarian-BTB/Iteracion_"$index"/bg_btb-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Catalan-AnCora/Iteracion_"$index"/ca_ancora-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Chinese-GSD/Iteracion_"$index"/zh_gsd-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Czech/CAC/Iteracion_"$index"/cs_cac-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Czech/CLTT/Iteracion_"$index"/cs_cltt-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Czech/FicTree/Iteracion_"$index"/cs_fictree-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Czech/PDT/Iteracion_"$index"/cs_pdt-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Dutch/Alpino/Iteracion_"$index"/nl_alpino-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Dutch/LassySmall/Iteracion_"$index"/nl_lassysmall-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/English-EWT/Iteracion_"$index"/en_ewt-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Finnish-TDT/Iteracion_"$index"/fi_tdt-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/French-GSD/Iteracion_"$index"/fr_gsd-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/German-GSD/Iteracion_"$index"/de_gsd-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Hebrew-HTB/Iteracion_"$index"/he_htb-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Italian-ISDT/Iteracion_"$index"/it_isdt-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Norwegian/Bokmaal/Iteracion_"$index"/no_bokmaal-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Norwegian/Nynorsk/Iteracion_"$index"/no_nynorsk-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Romanian-RRT/Iteracion_"$index"/ro_rrt-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Russian/GSD/Iteracion_"$index"/ru_gsd-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Russian/SynTagRus/Iteracion_"$index"/ru_syntagrus-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Spanish/AnCora/Iteracion_"$index"/es_ancora-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Spanish/GSD/Iteracion_"$index"/es_gsd-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Tamil-TTB/Iteracion_"$index"/ta_ttb-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Uyghur-UDT/Iteracion_"$index"/ug_udt-predicted_udpipe-test.conll \
    --tree
done
...
for index in {1..3}; do
  python -u -m supar.cmds.biaffine_dep predict --device 0 \
    ...
    --pred models/Pruebas_Punct/Wolof-WTB/Iteracion_"$index"/wo_wtb-predicted_udpipe-test.conll \
    --tree
done
